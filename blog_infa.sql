...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 06 nov. 2020 à 21:35
...
INSERT INTO `news` (`id`, `title`, `contenu`, `date_creation`) VALUES
...
INSERT INTO `users` (`id`, `firstName`, `lastName`, `email`, `phone`, `adress`, `cityZIp`, `city`, `password`, `avatar`, `role`) VALUES
